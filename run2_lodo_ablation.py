""" Dedicated LODO Ablation Pipeline: Run 2 (Target HC18) """
import os
import random
import numpy as np
import pandas as pd
...
def main():
    ...
    # HARDCODED TO RUN 2 (Target: HC18)
    config = {"name": "Run2_Target_HC18", "train": [(HEAD_FP_TRAIN_CSV, HEAD_FP_IMAGES), (HEAD_UCL_CSV, HEAD_UCL_IMAGES)], "test": (HEAD_HC18_CSV, HEAD_HC18_IMAGES)}
