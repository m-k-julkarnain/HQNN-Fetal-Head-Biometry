""" Dedicated LODO Ablation Pipeline: Run 3 (Target FP) """
import os
import random
import numpy as np
import pandas as pd
...
def main():
    ...
    # HARDCODED TO RUN 3 (Target: FP)
    config = {"name": "Run3_Target_FP", "train": [(HEAD_HC18_CSV, HEAD_HC18_IMAGES), (HEAD_UCL_CSV, HEAD_UCL_IMAGES)], "test": (HEAD_FP_TEST_CSV, HEAD_FP_IMAGES)}
